...
class DefendantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Defendant
        fields = ['first_name', 'last_name', 'gender', 'age_range', 'citizenship', 'profession'] 
...
class CaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Case
        fields = ['country', 'summary', 'defendants', 'plaintiffs', 
                  'date', 'platform', 'current_status', 
                  ...
                  'date_of_post', 'date_of_contact', 'date_of_investigation', 'date_of_detention',
