...
LEGAL_ENTITY_CHOICES = [
    ...
    (_('Jordan'), (
        ('jo magistrate', _('Magistrate’s Courts')),
        ('jo first instance', _('Courts of First Instance')),
        ('jo appeal', _('Courts of Appeal')),
        ('jo cessation', _('Courts of Cassation')),
        ('jo administrative', _('Administrative court')),
